...
class Locators:
    ...
    REGISTRATION_FIELD_EMAIL = [By.XPATH, '//label[text()="Email"]/following-sibling::input']
    REGISTRATION_FIELD_PASSWORD = [By.XPATH, '//label[text()="Пароль"]/following-sibling::input']
