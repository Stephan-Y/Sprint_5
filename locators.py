...
class Locators:
    ...
    REGISTRATION_FIELD_NAME = [By.XPATH, '//input[@class="text input__textfield text_type_main-default"]']
    REGISTRATION_FIELD_EMAIL = [By.XPATH, './html/body/div/div/main/div/form/fieldset[2]/div/div/input']
    REGISTRATION_FIELD_PASSWORD = [By.XPATH, './html/body/div/div/main/div/form/fieldset[3]/div/div/input']
    ...
    ENTER_TO_ACCOUNT_BUTTON = [By.XPATH, "./html/body/div/div/main/section[2]/div/button"]
    ...
    SAVE_BUTTON_ON_PERSONAL_PAGE = [By.XPATH, "//*[contains(text(), 'Сохранить')]"]
